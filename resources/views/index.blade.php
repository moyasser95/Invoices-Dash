				...
				<div class="breadcrumb-header justify-content-between">
					<div class="left-content">
						<div>
						  ...
						  <p class="mg-b-0 tx-15">لوحة تحكم برنامج فواتير.</p>
						</div>
					</div>
					<div class="main-dashboard-header-right">
						...
						<div>
							<label class="tx-13">المبيعات أونلاين</label>
							<h5>563,275</h5>
						</div>
						<div>
							<label class="tx-13">المبيعات أوفلاين</label>
							<h5>783,675</h5>
						</div>
					</div>
				</div>
				...
				<div class="row row-sm">
					<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-primary-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
									<h6 class="mb-3 tx-17 text-white">إجمالى الفواتير</h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">
                                                {{number_format(App\Models\Invoices::sum('Total'),2)}}EG
                                            </h4>
											<p class="mb-0 tx-15 text-white op-7">
							...
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">
                                                {{number_format(App\Models\Invoices::where('Value_Status','1')->sum('Total'),2)}}EG
                                            </h4>
											<p class="mb-0 tx-15 text-white op-7">
							...
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">
                                                {{number_format(App\Models\Invoices::where('Value_Status','3')->sum('Total'),2)}}EG
                                            </h4>
											<p class="mb-0 tx-15 text-white op-7">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-danger-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
									<h6 class="mb-3 tx-15 text-white">الفواتير الغير مدفوعة</h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">
                                                {{number_format(App\Models\Invoices::where('Value_Status','2')->sum('Total'),2)}}EG
                                            </h4>
											<p class="mb-0 tx-15 text-white op-7">
							...
							<div class="card-body">
								<div class="total-revenue">
									...
									<div>
									  ...
									  <label><span class="bg-danger"></span>مدفوعة جزئياً</label>
									</div>
									<div>
									  <h4>
